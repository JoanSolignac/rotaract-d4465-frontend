            ...
            <div className="flex flex-col max-h-[90vh]">
                ...
                <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600 bg-gray-50">
                    <div className="flex flex-col gap-1 w-full pr-8">
                        ...
                        <div>
                            <Badge color={getEstadoBadgeColor(data.estadoProyecto)} className="inline-block px-2 py-0.5 text-xs">
                                {data.estadoProyecto}
                            </Badge>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                            ...
                            <div className="lg:col-span-2 space-y-4">
                                ...
                                {/* Objetivo */}
                                <div>
                                    <h4 className="text-sm font-bold text-gray-900 mb-1">Objetivo</h4>
                                    <p className="text-gray-700 leading-relaxed whitespace-pre-wrap text-sm text-justify">
                                        {data.objetivo}
                                    </p>
                                </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="bg-white border rounded-lg p-3 shadow-sm">
                                    ...
                                    <div className="space-y-1.5 text-xs">
                                        <div className="flex justify-between text-blue-700 bg-blue-50 p-1 rounded">
                ...
                <div className="flex items-center justify-end p-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600 bg-gray-50">
                    ...
                    >
                        {cuposCompletos ? "Cupos completos" : !disponible ? "No disponible" : "Postular ahora"}
                    </Button>
                </div>
            </div>
        </Modal>
