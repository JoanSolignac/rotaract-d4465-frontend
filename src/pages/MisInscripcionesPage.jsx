...
import { Card, Badge, Button, Spinner, TextInput, Select } from 'flowbite-react';
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <section className="bg-gradient-to-r from-primary-600 to-primary-700 text-white py-12">
                <div className="max-w-screen-xl mx-auto px-4 text-center">
                    <h1 className="text-3xl md:text-4xl font-extrabold mb-2">Mis Inscripciones</h1>
                    <p className="text-lg text-primary-100">Gestiona tus postulaciones a actividades.</p>
                </div>
            </section>
                                    ...
                                    {filteredInscripciones.map((inscripcion) => (
                                        <Card key={inscripcion.id} className="hover:shadow-lg transition-shadow">
                                            <div className="flex justify-between items-start mb-2">
                                                <Badge color={getBadgeColor(inscripcion.estado)}>{inscripcion.estado}</Badge>
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">{inscripcion.referenciaTitulo}</h3>
                                            <p className="text-sm text-gray-600 mb-4">Tipo: {inscripcion.tipo}</p>
                                            ...
                                            <Button
                                                ...
                                                className={`w-full text-white ${inscripcion.estado === 'PENDIENTE' ? 'bg-[#B40032] hover:bg-[#8a0026] border-none focus:ring-[#B40032]' : ''}`}
                                            >
